...
app.post('/submitUser', async (req, res) => {
	...
	await userCollection.insertOne({ username: username, profile_pic: "profile-logo.png", friendsList: [], itemList: [], email: email, password: hashedPassword, slotsCurrency: 0, ownedProfilePics: [], titles: ["New around the block"], bio: "Click Edit Profile to change your profile", UserTitle : "New around the block"});
